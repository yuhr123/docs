...
These environment variables configure publishing regular operational logs
and audit logs to an HTTP webhook. See :ref:`minio-logging` for more
...
The following section documents environment variables for configuring MinIO
to publish logs to an HTTP webhook endpoint.
See :ref:`minio-logging` for more complete documentation and tutorials on
...
targets for regular and audit logs respectively:
...
.. envvar:: MINIO_LOGGER_WEBHOOK_ENABLE
   ...
   Specify ``"on"`` to enable publishing logs to the HTTP webhook target.
...
The following section documents environment variables for configuring MinIO
to publish audit logs to an HTTP webhook endpoint.
See :ref:`minio-logging` for more complete documentation and tutorials on
using these environment variables.
